...
$page = new HtmlPage('plg-awards-delete', $headline);
...
if (isset($_POST['submit_ok'])) {
    ...
    <div class="card mt-3" id="edit_awards_form">
        <div class="card-body">
            <button id="btnSave" type="submit" name="submit_ok" value="submit_ok" class="btn btn-danger"><i class="bi bi-trash"></i>&nbsp;OK</button>
        </div>
    </div>
    </form>');
}
